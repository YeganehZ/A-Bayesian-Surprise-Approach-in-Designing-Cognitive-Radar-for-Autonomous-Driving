...
% radar algorithm based on the Expectation of Bayesian Surprise for the urban 
...
x0 =[15; 1; 30; 14; 1];         % true initial state vector
xpred0=[14.5; 1; 28; 14; 1];    % initial state estimation mean vector
Ppred0=diag([100,1,100, 100, 1]);  % initial state estimation covariance matrix
B=10^8;  % Bandwidth 
distance=30; % initial distance between two vehicles
